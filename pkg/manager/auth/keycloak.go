...
func getAuthLogic() (map[string][]string, map[string][]string) {
	...
	api_permissions := map[string][]string {
		// viewer
		/*
		"/manager-api/agent/list": []string{"admin", "viewer"},
		"/manager-api/entry/list": []string{"admin", "viewer"},
		"/manager-api/tornjak/serverinfo": []string{"admin", "viewer"},
		"/manager-api/tornjak/selectors/list": []string{"admin", "viewer"},
		"/manager-api/tornjak/agents/list": []string{"admin", "viewer"},
		"/manager-api/tornjak/clusters/list": []string{"admin", "viewer"},
		// admin
		"/manager-api/agent/ban": []string{"admin"},
		"/manager-api/agent/delete": []string{"admin"},
		"/maanger-api/agent/createjointoken": []string{"admin"},
		"/manager-api/entry/create": []string{"admin"},
		"/manager-api/entry/delete": []string{"admin"},
		"/manager-api/tornjak/selectors/register": []string{"admin"},
		"/manager-api/tornjak/clusters/create": []string{"admin"},
		"/manager-api/tornjak/clusters/edit": []string{"admin"},
		"/manager-api/tornjak/clusters/delete": []string{"admin"},*/
		// manager
		"/manager-api/server/list": []string{"manager"},
		"/manager-api/server/register": []string{"manager"},
	}
	role_mappings := map[string][]string {
		"tornjak-viewer-realm-role": []string{"viewer"},
		"tornjak-admin-realm-role": []string{"admin"},
		"tornjak-manager-realm-role": []string{"manager"},
	}
