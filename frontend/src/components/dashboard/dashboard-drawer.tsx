...
class DashboardDrawer extends React.Component<DashboardDrawerProp> {
    constructor(props:DashboardDrawerProp) {
        super(props);
        let selectedTab = 0;
    ...
    assignDashboardPath(entity:string, tabIndex:number) {
