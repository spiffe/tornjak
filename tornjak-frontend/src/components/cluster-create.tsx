...
class ClusterCreate extends Component<ClusterCreateProp, ClusterCreateState> {
  ...
  componentDidMount() {
    ...
    if (IsManager) {
      if (
        ...
        this.TornjakApi.populateAgentsUpdate(
          this.props.globalServerSelected,
          this.props.agentsListUpdateFunc,
          this.props.tornjakMessageFunc
        );
        this.TornjakApi.populateTornjakServerInfo(
          this.props.globalServerSelected,
      ...
      this.TornjakApi.populateLocalAgentsUpdate(
        this.props.agentsListUpdateFunc,
        this.props.tornjakMessageFunc
      );
      this.TornjakApi.populateLocalTornjakServerInfo(
        this.props.tornjakServerInfoUpdateFunc,
        this.props.tornjakMessageFunc
      );
      this.TornjakApi.populateServerInfo(
        this.props.globalTornjakServerInfo,
        this.props.serverInfoUpdateFunc
      );
    }
  }
  ...
  getApiEntryCreateEndpoint() {
    if (!IsManager) {
      ...
      return (
        GetApiServerUri("/manager-api/tornjak/clusters/create") +
        "/" +
...
const mapStateToProps = (state: { clusters: { globalClusterTypeInfo: []; }; servers: { globalServerSelected: string; globalSelectorInfo: []; globalServerInfo: []; globalTornjakServerInfo: ""; globalWorkloadSelectorInfo: []; }; agents: { globalAgentsList: []; globalAgentsWorkLoadAttestorInfo: []; }; tornjak: { globalErrorMessage: string; }; }) => ({
