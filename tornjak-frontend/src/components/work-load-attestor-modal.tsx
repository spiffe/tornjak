...
type WorkLoadAttestorProp = {
    spiffeid: any,
    globalServerSelected: any,
    globalAgentsList: [],
    globalWorkloadSelectorInfo: any,
...
class WorkLoadAttestor extends React.Component<WorkLoadAttestorProp, WorkLoadAttestorState> {
    ...
    onChangeWorkloadPlugin = (selected: { selectedItem: { label: any; }; }) => {
        var selectors = "";
    ...
    render() {
        ...
        return (
            <div data-test="work-load-attestor">
                <ModalWrapper
...
const mapStateToProps = (state: { servers: { globalServerSelected: any; globalWorkloadSelectorInfo: any; }; agents: { globalAgentsList: any; }; }) => ({
